...
class FirstDM(webapp.RequestHandler):
    def get(self):
        newDM = DirectMessage()
        newDM.id = "4111634087"
        newDM.text = "Testing this DM malarky"
        newDM.date = pocketaccountant.correct_for_dst(DirectMessage.make_datetime("Sun Sep 11 09:46:23 +0000 2011"))
        db.put(newDM)
